  ...
  return (
    <>
      ...
      <section className="textPage">
        ...
        <p>This web app is an independent, [something] experimental project made by <a href="https://twitter.com/itsvitoracacio" target="blank">Vitor</a> and <a href="https://twitter.com/edulopeso" target="blank">Eduardo</a>.</p>
        ...
        <p>So we hope you enjoy playing and guessing half as much as we enjoyed building this for you. And if you want to get in touch, we're [something something] on twitter almost every day, just click on our names above.</p>
